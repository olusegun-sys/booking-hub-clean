...
export const api = {
  ...
  searchBusinesses: (params) =>
    request(`/businesses/search/category?${new URLSearchParams(params)}`),
  registerBusiness: (data) =>
    request("/businesses/register", {
      method: "POST",
  ...
  createRoom: (businessId, data) =>
    request(`/businesses/${businessId}/rooms/create`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateRoom: (businessId, roomId, data) =>
    request(`/businesses/${businessId}/rooms/${roomId}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteRoom: (businessId, roomId) =>
    request(`/businesses/${businessId}/rooms/${roomId}`, { method: "DELETE" }),

  // ---------- Bookings ----------
  createBooking: (data) =>
    request("/bookings", { method: "POST", body: JSON.stringify(data) }),
  getBusinessBookings: (businessId) =>
    request(`/businesses/${businessId}/bookings`),

  // ---------- Payments ----------
  createPayment: (data) =>
    request("/create-payment", { method: "POST", body: JSON.stringify(data) }),
  verifyPayment: (data) =>
    request("/verify-payment", { method: "POST", body: JSON.stringify(data) }),
  ...
  // ---------- Staff ----------
  staffLogin: (data) =>
    request("/staff/login", { method: "POST", body: JSON.stringify(data) }),
  getStaff: (businessId) => request(`/businesses/${businessId}/staff`),
  addStaff: (businessId, data) =>
    request(`/businesses/${businessId}/staff`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  ...
  getOperatingHours: (businessId) =>
    request(`/businesses/${businessId}/operating-hours`),
  updateOperatingHours: (businessId, data) =>
    request(`/businesses/${businessId}/operating-hours`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  getBlockedDates: (businessId) =>
    request(`/businesses/${businessId}/blocked-dates`),
  blockDate: (businessId, data) =>
    request(`/businesses/${businessId}/block-date`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  unblockDate: (businessId, date) =>
    request(`/businesses/${businessId}/block-date/${date}`, {
      method: "DELETE",
    }),

  // ---------- Domain ----------
  getDomainInfo: (domain) => request(`/domain-info?domain=${domain}`),
  generateVerification: (businessId) =>
    request(`/businesses/${businessId}/generate-verification`, {
      method: "POST",
    }),
  checkVerification: (businessId) =>
    request(`/businesses/${businessId}/check-verification`, { method: "POST" }),

  // ---------- Gallery ----------
  getGallery: (businessId) => request(`/businesses/${businessId}/gallery`),
  addGalleryImage: (businessId, data) =>
    request(`/businesses/${businessId}/gallery`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  deleteGalleryImage: (businessId, imageId) =>
    request(`/businesses/${businessId}/gallery/${imageId}`, {
      method: "DELETE",
    }),
  reorderGallery: (businessId, imageIds) =>
    request(`/businesses/${businessId}/gallery/reorder`, {
      method: "PUT",
      body: JSON.stringify({ imageIds }),
    }),
  uploadGalleryImage: (data) =>
    request("/upload-gallery-image", {
      method: "POST",
      body: JSON.stringify(data),
    }),
