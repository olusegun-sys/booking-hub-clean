...
function AdminDashboard({ admin, onLogout }) {
  ...
  return React.createElement('div', { style: { minHeight: '100vh', backgroundColor: '#f8fafc' } },
    ...
    deleteModal.isOpen && React.createElement('div', {
      ...
      React.createElement('div', { style: { backgroundColor: 'white', borderRadius: '24px', maxWidth: '420px', width: '100%', overflow: 'hidden' } },
    ...
    React.createElement('main', { style: { maxWidth: '1400px', margin: '0 auto', padding: isMobile ? '16px' : '24px' } },
      ...
      React.createElement('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '12px' } },
        ...
        React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: '8px', backgroundColor: 'white', padding: isMobile ? '6px 12px' : '8px 16px', borderRadius: '40px', border: '1px solid #e2e8f0', width: isMobile ? '100%' : '260px' } },
          ...
          React.createElement('input', { type: 'text', placeholder: 'Search...', value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), style: { border: 'none', outline: 'none', fontSize: isMobile ? '12px' : '14px', color: '#0f172a', background: 'transparent', width: '100%' } }),
          searchTerm && React.createElement('button', { onClick: () => setSearchTerm(''), style: { background: 'none', border: 'none', cursor: 'pointer', color: '#94a3b8', fontSize: '14px' } }, '×')
        )
      ),
